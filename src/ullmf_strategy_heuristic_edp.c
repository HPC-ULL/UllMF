...
static ullmf_strategy_heuristic_edp_t _ullmf_strategy_heuristic_edp = {
    .parent.parent._class.size = sizeof(ullmf_strategy_heuristic_edp_t),
    .parent.parent._class.name = ullmf_strategy_heuristic_edp_class,
    .parent.parent.mdevice = (measurement_device_t *) &ullmf_eml_edp_device,
...
ullmf_strategy_t * ullmf_strategy_heuristic_edp = (ullmf_strategy_t *) &_ullmf_strategy_heuristic_edp;
